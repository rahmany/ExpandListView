...
public class JSONObjectclient extends AsyncTask<String, Void, JSONObject> {
	...
	getJSONObjectListener getJSONObjectListener;
	Context curContext;

	public JSONObjectclient(Context context, getJSONObjectListener listener) {
		this.getJSONObjectListener = listener;
		curContext = context;
	}

	public JSONObjectclient(scheduleFragment scheduleFragment,
			getJSONObjectListener listener) {
	...
	protected void onPostExecute(JSONObject json) {
		try {
			getJSONObjectListener.onRemoteCallComplete(json);
		} catch (JSONException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
